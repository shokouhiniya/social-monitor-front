    ...
    try {
      ...
      if (err.response?.status === 429 || errorMessage.includes('Rate limit')) {
        setError(
          ...
          'Your RapidAPI subscription has reached its request limit. ' +
          'Please wait for the limit to reset (usually 1 hour) or upgrade your plan.\n\n' +
      ...
      <DialogContent>
        <Box sx={{ pt: 2 }}>
          <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
            Enter a Twitter username to monitor their activity. The system will fetch their profile
            and recent tweets.
          </Typography>
          ...
          <TextField
            ...
            sx={{ mb: 2 }}
          >
            {Object.entries(PAGE_CATEGORY_LABELS).map(([k, v]) => (
