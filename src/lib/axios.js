...
export const endpoints = {
  ...
  definitions: {
    list: '/definitions',
    create: '/definitions',
    update: (id) => `/definitions/${id}`,
    remove: (id) => `/definitions/${id}`,
  },
  microMedia: {
    list: '/micro-media',
    create: '/micro-media',
    bulk: '/micro-media/bulk',
    representatives: '/micro-media/representatives',
    byCluster: (clusterId) => `/micro-media/by-cluster/${clusterId}`,
    byIdentity: '/micro-media/by-identity',
    setRepresentative: (id) => `/micro-media/${id}/representative`,
